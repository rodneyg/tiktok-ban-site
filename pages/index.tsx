...
export default function Home() {
  const banDate = new Date('2024-11-04T00:00:00');
  const now = new Date();
  ...
  return (
    <div className="min-h-screen bg-white text-black p-6 flex flex-col items-center justify-center space-y-10">
      <div className="text-center space-y-4">
        ...
        <p className={`text-5xl font-extrabold ${daysLeft < 30 ? 'text-red-600' : daysLeft < 60 ? 'text-yellow-500' : 'text-green-600'}`}>
          {daysLeft} Days Left
        </p>
        <p className="text-sm text-gray-500">(Based on current U.S. deadline: November 4, 2024)</p>
      </div>
      ...
      <div className="w-full max-w-xl space-y-6">
        <div className="border p-4 rounded-xl shadow-md">
          ...
          <div className="space-y-4">
            <div className="bg-gray-100 p-4 rounded-lg">
              ...
              <a href="https://nordvpn.com/" target="_blank" className="mt-2 inline-block text-blue-600 underline">
        ...
        <div className="border p-4 rounded-xl shadow-md bg-blue-50">
          ...
          <p>TikTok is still live. There is no ban this weekend. The next major decision deadline is <strong>November 4, 2024</strong>.</p>
        </div>

        <div className="text-center border-t pt-6">
          <p className="text-sm">Built by creators. Help us stay independent and ad-free.</p>
          <a href="https://ko-fi.com/yourusername" target="_blank" className="mt-2 inline-block text-white bg-black px-4 py-2 rounded-full font-semibold">
            Support with $3
          </a>
        </div>
      </div>
